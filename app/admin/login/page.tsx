  ...
  return (
    <div className="min-h-screen bg-bci-dark flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        <div className="bg-bci-navy p-6 flex flex-col items-center justify-center text-white">
          <ShieldCheck size={48} className="mb-2" />
          <h1 className="text-2xl font-bold">Banco de Comércio e Indústria</h1>
          <p className="text-white/80">Área do Administrador</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-bci-navy focus:border-bci-navy"
